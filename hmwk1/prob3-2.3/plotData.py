...
class plotData:
    ...
    def __init__(self):
        ...
        self.thetaref_history = []  # reference position z_r
        self.theta_history = []  # angle theta
        self.Force_history = []  # control force

        # create a handle for every subplot.
        self.handle = []
        # self.handle.append(myPlot(self.ax[0], ylabel='z(m)'))
        self.handle.append(myPlot(self.ax[0], ylabel='theta(deg)', title='Pendulum Data'))
    ...
    def updatePlots(self, t, reference, states, ctrl):
        ...
        self.thetaref_history.append(180.0/np.pi*reference[0])  # reference base position
        ...
        self.handle[0].updatePlot(self.time_history, [self.theta_history, self.thetaref_history])
